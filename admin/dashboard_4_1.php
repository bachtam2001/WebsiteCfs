...
<head>
    ...
    <title>CLA Confessions and Memories Admin Panel | Dashboard </title>
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?$response = $fb->get('/'.$_SESSION['User_ID'].'/?fields=name', $_SESSION['User_Token']); $graphNode = $response->getDecodedBody(); echo $graphNode["name"];?></strong>
